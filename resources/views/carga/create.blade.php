...
<form class="form" method="GET" action="{{ url('/carga') }}">
    @csrf
    <h2 class="form_title">Registrar alumno</h2>
    <div class="form_container">

    <div class="form_group">
            <input type="text" name="username" id="username" class="form_input" placeholder=" ">
            <label for="username" class="form_label">Nombre alumno:</label>
    ...
    <div class="form_group">
        <input type="text" name="username" id="username" class="form_input" placeholder=" ">
        <label for="username" class="form_label">grupo:</label>
        <span class="form_line"></span>
    </div>

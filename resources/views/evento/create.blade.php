...
<form class="form" method="GET" action="{{ url('/evento') }}">
    @csrf
    <h2 class="form_title">Registrar evento</h2>
    ...
    <div class="form_group">
        ...
        <div class="form_group">
            <input type="text" name="username" id="username" class="form_input" placeholder=" ">
            <label for="username" class="form_label">Tipo:</label>
            <span class="form_line"></span>
        </div>

        <div class="form_group">
            <input type="text" name="username" id="username" class="form_input" placeholder=" ">
            <label for="username" class="form_label">Fecha:</label>
            <span class="form_line"></span>
        </div>

        <div class="form_group">
            <input type="text" name="username" id="username" class="form_input" placeholder=" ">
            <label for="username" class="form_label">Hora:</label>
            <span class="form_line"></span>
        </div>

        <div class="form_group">
            <input type="text" name="username" id="username" class="form_input" placeholder=" ">
            <label for="username" class="form_label">Lugar:</label>
            <span class="form_line"></span>
        </div>

        <div class="form_group">
            <input type="text" name="username" id="username" class="form_input" placeholder=" ">
            <label for="username" class="form_label">Capacidad:</label>
            <span class="form_line"></span>
        </div>
